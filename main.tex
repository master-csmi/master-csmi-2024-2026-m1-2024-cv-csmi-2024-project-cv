...
\begin{tabular}{r| p{0.5\textwidth} c}
    ...
    \textbf{Computer science:} programming, algorithms, data structures.}{logo.png} \\
    ...
    regression, multidimensional data analysis, mathematical statistics.}{allameh.png} \\
    \cvevent{2014-2018}{Mathematics and Physics General}{Diplome}{Nemooneh Tarbiat High School \color{cvred}}{}{w.png} \\
\end{tabular}
\vspace{3em}
